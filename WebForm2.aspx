                    ...
                    <invoiceitem>
                      ...
                      <totorder>
                          <xsl:value-of select="./totorder" />
                            ...
                            <tr>
                                <td valign="top">Roll No.
                                </td>
                                <td valign="top">VSN
                                </td>
                                <td valign="top">RH SKU
                                </td>
                                <td valign="top">ITEM NO.
                                </td>
                                <td valign="top">PO#
                                </td>
                                ...
                                <td valign="top">Per Pc SQ. FT.
                                </td>
                                <td valign="top">COLOR
                                </td>
                                <td valign="top">SIZE IN FT.INCH
                                </td>
                                <td valign="top">Roll#
                                </td>
                                <td valign="top">DC
                                </td>
                                <td valign="top">TOTAL SQ FT
                                </td>

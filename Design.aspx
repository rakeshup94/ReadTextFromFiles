<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Design.aspx.cs" Inherits="WebApplication3.Design" %>
                      ...
                      <invoicedate>
                          <xsl:value-of select="./INVOICEDATE" />
                            ...
                            <tr>
                                ...
                                <td class="auto-style3">Total Area Sq. Mtr.</td>
                                <td>Barcode Line</td>
                                ...
                                <xsl:for-each select="./Rolls/RollItem">
                                    <rollitem>
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style3">Total Area Sq. Mtr.   
                                                <xsl:value-of select="RollTo" />
                                            </td>
                                            <td>Barcode Line   
                                                <xsl:value-of select="RollTo" />
                                            ...
                                            <td>Approx.Total Net Weight    
                                                <xsl:value-of select="RollTo" />
                                            </td>
                                            <td>
                                                <xsl:value-of select="SinglePcsGrossWt" />
                                            </td>
                                            <td>Approx.Total Gross Weight    
                                                <xsl:value-of select="RollTo" />
                                            </td>
                                            <td>Approx.Dimension in CM    
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <xsl:variable name="totalAmount" select="number(sum(././Rolls/RollItem/TotalRoll))" />
                                </td>
                                <td></td>
                                <td></td>
                                <td></td>
                                ...
                                <td>
                                    ...
                                    <xsl:variable name="totalAmount" select="number(sum(././Rolls/RollItem/TotalPcs))" />
                                </td>

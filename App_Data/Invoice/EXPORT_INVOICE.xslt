            ...
            <InvoiceItem>
              <table width="700" border="1" align="center" cellpadding="0" cellspacing="0" style="border: solid 1px #333">
                ...
                <tr>
                  ...
                  <td align="center" valign="middle">
                    <strong>
                      <xsl:value-of select="format-number(number(sum(././Rolls/RollItem/AREAMT)),'#.##')" />
                    </strong>
                  </td>
                  <td align="center" valign="middle">
                    <strong>
                  ...
                  <td align="center" valign="middle">
                    <strong>
                      <xsl:variable name="totalAmount" select="format-number(sum(././Rolls/RollItem/TotalAmount),'#.##')" />
                      <xsl:value-of select="$totalAmount" />
                    </strong>
                  </td>
                </tr>
                <tr>
                  <td align="left" colspan="7" valign="middle">
                    <strong>
                      Amount Payable (in word)                        <xsl:value-of select="myUtils:NumberToWords(sum(././Rolls/RollItem/TotalAmount))" />                        Only.
                    </strong>
                  </td>
                  <td align="center" valign="middle">
                    <strong>                        Total                      </strong>
                ...
                <tr>
                  <td valign="top" rowspan="2" class="noBorder">                    </td>
                ...
                <tr>
                  <td valign="middle" colspan="4" class="noBorder">                    </td>
                  <td align="left" valign="middle" colspan="4">                                            Total Tax Invoice value INR                    </td>
                  <td align="center" valign="middle">
                ...
                <tr>
                  ...
                  <td align="left" valign="middle" colspan="4">                        Round Off Tax Invoice value                                          </td>
                  <td align="center" valign="middle">
                    <xsl:value-of select="format-number($GrossAmount,'#.##')" />
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="9" class="noBorder">                      Declaration :                      </td>
                </tr>
                <tr>
                  <td colspan="6" valign="middle" class="noBorder">

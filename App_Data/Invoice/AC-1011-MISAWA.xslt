            ...
            <invoiceitem>
              <table width="700" border="1" align="center" cellpadding="0" cellspacing="0" style="border: solid 1px #333">
                ...
                <tr>
                  ...
                  <td align="center" valign="middle">
                    <strong>
                      Price FOB                          <br />                          US$ /Sq. <xsl:value-of select="./UNITNAME" /> 
                    </strong>
                  </td>
                  <td align="center" valign="middle">
                    <strong>
                ...
                <tr>
                  ...
                  <td align="center" valign="middle">                        F.O.B                        </td>
                  <td align="center" valign="middle">
                    <strong>
                ...
                <tr>
                  <td colspan="3" align="center" valign="middle">
                    <p>                          HS CODE : 57031010                        </p>
                    <p>
                      Amount Chargeable : US$                              <strong>
                        <xsl:value-of select="myUtils:NumberToWords(sum(././Rolls/RollItem/TotalAmount))" />                            Only.
                      </strong>
                    </p>
                  </td>
                  <td colspan="5" align="right" valign="top" >
                ...
                <tr>
                  <td valign="top" colspan="9" class="noBorder">
                    <p>
                      <strong>                            Contents : - Hand Tufted Woolen Carpets : 80% Wool + 20% Cotton                          </strong>
                    </p>
                  </td>
                </tr>
                <tr>
